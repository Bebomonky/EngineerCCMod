function Create(self)
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Khrabarovsk JS50", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Khrabarovsk JS50", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED Khrabarovsk JS50", "CED.rte");
	...
	-- this way.
	reloadPhase.prepareSoundLength = 450;
	-- Sound upon finishing the phase.
	reloadPhase.afterSound = CreateSoundContainer("Mag Out CED Khrabarovsk JS50", "CED.rte");
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = true;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED Khrabarovsk JS50", "CED.rte");
	reloadPhase.prepareDelay = 460;
	reloadPhase.prepareSoundLength = 460;
	reloadPhase.afterSound = CreateSoundContainer("Mag In CED Khrabarovsk JS50", "CED.rte");
	...
	reloadPhase.afterSound = CreateSoundContainer("Bolt Back CED Khrabarovsk JS50", "CED.rte");
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = nil;
	reloadPhase.prepareDelay = 110;
	reloadPhase.prepareSoundLength = 0;
	reloadPhase.afterSound = CreateSoundContainer("Bolt Forward CED Khrabarovsk JS50", "CED.rte");
	reloadPhase.afterDelay = 350;
	...
	self.HEATRecoilHorizontalAnim = 7;
	-- Strength of the rotational "kick" animation when firing.
	self.HEATRecoilAngAnim = 6;
