function Create(self)
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Xarix MTX Directive", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Xarix MTX Directive", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED Xarix MTX Directive", "CED.rte");
	...
	reloadPhase.afterSound = CreateSoundContainer("Mag Out CED Xarix MTX Directive", "CED.rte");
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = true;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED Xarix MTX Directive", "CED.rte");
	...
	reloadPhase.prepareDelay = 20;
	reloadPhase.prepareSoundLength = 0;
	reloadPhase.afterSound = CreateSoundContainer("Bolt Forward CED Xarix MTX Directive", "CED.rte");
