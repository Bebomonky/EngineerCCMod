function Create(self)
	...
	self.HEATDoneReloadingCallback = function (self)
		...
		self.EXPTurbolanceMagRemoved = false;
		self.EXPTurbolanceMagAdded = false;
		self.EXPTurbolanceBeltRemoved = false;
		self.EXPTurbolanceBeltAdded = false;
	end
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED CED-EXP Turbolance", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED CED-EXP Turbolance", "CED.rte");
	...
	self.HEATFullMagazineRoundCount = 200;
	...
	self.HEATFakeMagazineMOSRotating = CreateMOSRotating("Fake Magazine MOSRotating CED CED-EXP Turbolance", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Raise Prepare CED CED-EXP Turbolance", "CED.rte");
	-- Time it takes to finish this phase.
	reloadPhase.prepareDelay = 900;
	-- Time before finishing that the prepareSound will play. You can line up short prepareSounds with long prepareDelays
	-- this way.
	reloadPhase.prepareSoundLength = 900;
	...
	reloadPhase.constantCallback = function (self)
		...
		if self.EXPTurbolanceOverheated and not self.HEATEmptyReload then
			self.HEATReloadPhaseOverride = 6;
		elseif self.EXPTurbolanceBeltAdded then
			self.HEATReloadPhaseOverride = 7;
		elseif self.EXPTurbolanceMagAdded then
			self.HEATReloadPhaseOverride = 5;
		elseif self.EXPTurbolanceMagRemoved then
			self.HEATReloadPhaseOverride = 4;
		elseif self.EXPTurbolanceBeltRemoved then
			self.HEATReloadPhaseOverride = 3;
		elseif self.HEATEmptyReload then
			self.HEATReloadPhaseOverride = 3;
		end
	end
	...
	reloadPhase.finishCallback = function (self)
		...
		self.EXPTurbolanceBeltRemoved = true;
	end
	reloadPhase.exitPhaseCallback = function (self)
	...
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.prepareDelay = 650;
	reloadPhase.prepareSoundLength = 430;
	reloadPhase.afterSound = CreateSoundContainer("Mag Out CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.afterDelay = 500;
	reloadPhase.reloadStanceOffsetTarget = Vector(1, 0);
	reloadPhase.reloadSupportOffsetSpeed = 16;
	reloadPhase.reloadSupportOffsetTarget = Vector(-1, 8)
	reloadPhase.rotationTarget = 65;
	reloadPhase.angVel = 2;
	reloadPhase.horizontalAnim = 0;
	reloadPhase.verticalAnim = 1;
	reloadPhase.autoAnimateFrames = false;
	...
	reloadPhase.finishCallback = function (self)
		self.HEATCurrentReloadPhaseData.reloadSupportOffsetTarget = Vector(2, 13);
		self.EXPTurbolanceMagRemoved = true;
	end
	reloadPhase.exitPhaseCallback = function (self)
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.prepareDelay = 2000;
	reloadPhase.prepareSoundLength = 1450;
	reloadPhase.afterSound = CreateSoundContainer("Mag In CED CED-EXP Turbolance", "CED.rte");
	...
	reloadPhase.constantCallback = function (self)
		if self.HEATReloadTimer:IsPastSimMS(self.HEATCurrentReloadPhaseData.prepareDelay) then
			self.HEATCurrentReloadPhaseData.reloadSupportOffsetTarget = Vector(0, 10);
		elseif self.HEATReloadTimer:IsPastSimMS(self.HEATCurrentReloadPhaseData.prepareDelay / 1.5) then
			self.HEATCurrentReloadPhaseData.reloadSupportOffsetTarget = Vector(0, 13);
		end
	end
	reloadPhase.finishCallback = function (self)
		self.EXPTurbolanceMagAdded = true;
	end
	reloadPhase.exitPhaseCallback = function (self)
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "BeltIn";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Belt In Prepare CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.prepareDelay = 930;
	...
	reloadPhase.finishCallback = function (self)
		self.EXPTurbolanceBeltAdded = true;
	end
	reloadPhase.exitPhaseCallback = function (self)
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "JamFix";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Jam Fix Prepare CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.prepareDelay = 700;
	reloadPhase.prepareSoundLength = 700;
	reloadPhase.afterSound = CreateSoundContainer("Jam Fix CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.afterDelay = 500;
	reloadPhase.reloadStanceOffsetTarget = Vector(1, 0);
	reloadPhase.reloadSupportOffsetSpeed = 10;
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "End";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("End Prepare CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.prepareDelay = 980;
	reloadPhase.prepareSoundLength = 980;
	reloadPhase.afterSound = CreateSoundContainer("End CED CED-EXP Turbolance", "CED.rte");
	reloadPhase.afterDelay = 200;
	...
	reloadPhase.constantCallback = function (self)
		...
		if self.EXPTurbolanceOverheated and self:IsReloading() then
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "ActiveCooling";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Active Cooling CED CED-EXP Turbolance", "CED.rte");
	...
	self.HEATPreSound = CreateSoundContainer("Spin Up CED CED-EXP Turbolance", "CED.rte");
