function Create(self)
	...
	self.HEATParticleUtilityFiringSmokeDataTable.Power = 20;
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Vossberg Atlastar", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Vossberg Atlastar", "CED.rte");
	...
	self.HEATFakeMagazineVelocity = Vector(-3, -3);
	...
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED Vossberg Atlastar", "CED.rte");
	-- Time it takes to finish this phase.
	reloadPhase.prepareDelay = 350;
	...
	reloadPhase.afterSound = CreateSoundContainer("Mag Out CED Vossberg Atlastar", "CED.rte");
	...
	reloadPhase.reloadStanceOffsetTarget = Vector(-3, 1);
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = true;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED Vossberg Atlastar", "CED.rte");
	reloadPhase.prepareDelay = 700;
	reloadPhase.prepareSoundLength = 700;
	reloadPhase.afterSound = CreateSoundContainer("Mag In CED Vossberg Atlastar", "CED.rte");
	reloadPhase.afterDelay = 200;
	reloadPhase.reloadStanceOffsetTarget = Vector(-3, 1);
	reloadPhase.reloadSupportOffsetSpeed = 16;
	...
	reloadPhase.constantCallback = function (self)
		...
		elseif self.HEATReloadTimer:IsPastSimMS(self.HEATCurrentReloadPhaseData.prepareDelay - self.HEATCurrentReloadPhaseData.prepareDelay / 2) then
			...
			self.HEATCurrentReloadPhaseData.reloadSupportOffsetTarget = Vector(-7, 4);	
		end
	end
	reloadPhase.finishCallback = function (self)
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "MagHit";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Mag Hit Prepare CED Vossberg Atlastar", "CED.rte");
	reloadPhase.prepareDelay = 270;
	reloadPhase.prepareSoundLength = 270;
	reloadPhase.afterSound = CreateSoundContainer("Mag Hit CED Vossberg Atlastar", "CED.rte");
	reloadPhase.afterDelay = 250;
	reloadPhase.reloadStanceOffsetTarget = Vector(0, 1);
	reloadPhase.reloadSupportOffsetSpeed = 15;
	...
	reloadPhase.constantCallback = function (self)
		...
		if self.HEATEmptyReload then
			self.HEATCurrentReloadPhaseData.afterDelay = 250;
		else
			...
			self.HEATCurrentReloadPhaseData.afterDelay = 600;
	...
	reloadPhase.afterSound = CreateSoundContainer("Bolt Back CED Vossberg Atlastar", "CED.rte");
	reloadPhase.afterDelay = 100;
	reloadPhase.reloadStanceOffsetTarget = Vector(4, -2);
	reloadPhase.reloadSupportOffsetSpeed = 16;
	reloadPhase.reloadSupportOffsetTarget = Vector(0, -3)
	...
	reloadPhase.prepareSoundLength = 0;
	reloadPhase.afterSound = CreateSoundContainer("Bolt Forward CED Vossberg Atlastar", "CED.rte");
