function Create(self)
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Xarix A-12 Axiom", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Xarix A-12 Axiom", "CED.rte");
	...
	reloadPhase.afterSound = CreateSoundContainer("Cylinder Open CED Xarix A-12 Axiom", "CED.rte");
	...
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Speedloader In Prepare CED Xarix A-12 Axiom", "CED.rte");
	reloadPhase.prepareDelay = 730;
	reloadPhase.prepareSoundLength = 250;
	reloadPhase.afterSound = CreateSoundContainer("Speedloader In CED Xarix A-12 Axiom", "CED.rte");
	reloadPhase.afterDelay = 235;
	reloadPhase.reloadStanceOffsetTarget = Vector(-3, 2);
	reloadPhase.reloadSupportOffsetSpeed = 16;
	...
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Cylinder Close Prepare CED Xarix A-12 Axiom", "CED.rte");
	reloadPhase.prepareDelay = 230;
	reloadPhase.prepareSoundLength = 50;
	reloadPhase.afterSound = CreateSoundContainer("Cylinder Close CED Xarix A-12 Axiom", "CED.rte");
	...
	self.HEATPreSound = CreateSoundContainer("Pre CED Xarix A-12 Axiom", "CED.rte");
