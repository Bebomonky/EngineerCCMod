function Create(self)
	...
	self.HEATParticleUtilityFiringSmokeDataTable.Power = 100;
	...
	self.HEATParticleUtilityFiringSmokeDataTable.LingerMult = 1.5;
	self.HEATParticleUtilityFiringSmokeDataTable.AirResistanceMult = 1.4;
	self.HEATParticleUtilityFiringSmokeDataTable.GravMult = 0.2;		
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Xarix EA Condor", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Xarix EA Condor", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED Xarix EA Condor", "CED.rte");
	-- Time it takes to finish this phase.
	reloadPhase.prepareDelay = 290;
	-- Time before finishing that the prepareSound will play. You can line up short prepareSounds with long prepareDelays
	-- this way.
	reloadPhase.prepareSoundLength = 290;
	-- Sound upon finishing the phase.
	reloadPhase.afterSound = CreateSoundContainer("Mag Out CED Xarix EA Condor", "CED.rte");
	...
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = true;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED Xarix EA Condor", "CED.rte");
	reloadPhase.prepareDelay = 1700;
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "ActuateBack";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Actuate Back Prepare CED Xarix EA Condor", "CED.rte");
	...
	i = i + 1;
	reloadPhase = {};
	reloadPhase.Name = "ActuateForward";
	reloadPhase.removesMag = false;
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = nil;
	reloadPhase.prepareDelay = 160;
	reloadPhase.prepareSoundLength = 0;
	reloadPhase.afterSound = CreateSoundContainer("Actuate Forward CED Xarix EA Condor", "CED.rte");
