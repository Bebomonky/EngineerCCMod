function Create(self)
	...
	self.HEATParticleUtilityFiringSmokeDataTable.Power = 75;
	self.HEATParticleUtilityFiringSmokeDataTable.Spread = 45;
	...
	self.HEATParticleUtilityFiringSmokeDataTable.LingerMult = 1.8;
