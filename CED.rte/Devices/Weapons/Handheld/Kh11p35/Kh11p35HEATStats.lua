function Create(self)
	...
	self.HEATReflectionOutdoorsSound = CreateSoundContainer("Reflection Outdoors CED Khrabarovsk 11p35-rifle", "CED.rte");
	-- CreateSoundContainer for your indoors tail sound.
	self.HEATReflectionIndoorsSound = CreateSoundContainer("Reflection Indoors CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Bolt Back Prepare CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	reloadPhase.afterSound = CreateSoundContainer("Bolt Back CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	reloadPhase.prepareSound = CreateSoundContainer("Mag Out Prepare CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	reloadPhase.autoProgressIfFinishedButInterrupted = true;
	reloadPhase.prepareSound = CreateSoundContainer("Mag In Prepare CED Khrabarovsk 11p35-rifle", "CED.rte");
	reloadPhase.prepareDelay = 700;
	reloadPhase.prepareSoundLength = 700;
	reloadPhase.afterSound = CreateSoundContainer("Mag In CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	reloadPhase.addsMag = false;
	reloadPhase.autoProgressIfFinishedButInterrupted = false;
	reloadPhase.prepareSound = CreateSoundContainer("Bolt Forward Prepare CED Khrabarovsk 11p35-rifle", "CED.rte");
	...
	self.HEATPreSound = CreateSoundContainer("Pre CED Khrabarovsk 11p35-rifle", "CED.rte");
