function Create(self)
	...
	self.BlockStaminaBlockCancelCost = 2.5;
	...
	self.HitSFX.SlashFlesh = CreateSoundContainer("Slash Flesh CED Combat Knife", "CED.rte");
	self.HitSFX.SlashMetal = CreateSoundContainer("Slash Metal CED Combat Knife", "CED.rte");
	self.HitSFX.StabFlesh = CreateSoundContainer("Stab Flesh CED Combat Knife", "CED.rte");
	self.HitSFX.StabMetal = CreateSoundContainer("Stab Metal CED Combat Knife", "CED.rte");
	...
	self.HitSFX.BeingBlocked = CreateSoundContainer("Being Blocked CED Combat Knife", "CED.rte");
	...
	self.BlockSFX = {};
	self.BlockSFX.BlockSlash = CreateSoundContainer("Block Slash CED Combat Knife", "CED.rte");
	self.BlockSFX.BlockStab = CreateSoundContainer("Block Stab CED Combat Knife", "CED.rte");
	self.BlockSFX.ParryAdd = CreateSoundContainer("Parry Add CED Combat Knife", "CED.rte");
	self.BlockSFX.HeavyBlockAdd = CreateSoundContainer("Heavy Block Add CED Combat Knife", "CED.rte");
	
	-- Sound for being disarmed if it's enabled. Follows the weapon.
	self.DisarmSound = CreateSoundContainer("Disarm CED Combat Knife");
	...
	self.PrimaryHotkeyInputPhaseSetName = "Overhead Stab PhaseSet";
	...
	Phase.stanceOffsetEnd = Vector(-6, -6);
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-6, -6);
	Phase.stanceOffsetEnd = Vector(-2, -2);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-2, -2);
	Phase.stanceOffsetEnd = Vector(15, -2);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-7, -2);
	...
	Phase.stanceOffsetEnd = Vector(-6, 5);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-6, 5);
	Phase.stanceOffsetEnd = Vector(6, -5);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(6, -5);
	Phase.stanceOffsetEnd = Vector(18, -5);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(15, -5);
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(0, 0);
	Phase.stanceOffsetEnd = Vector(-15, 6);
	Phase.stanceEasingFunc = self.EaseLinear;
	
	Phase.jointOffsetSpeed = 1;
	Phase.jointOffset = Vector(0, 5);
	Phase.supportOffsetSpeed = 1;
	Phase.supportOffset = Vector(0, -20);
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-15, 6);
	Phase.stanceOffsetEnd = Vector(-5, 6);
	Phase.stanceEasingFunc = self.EaseLinear;
	
	Phase.jointOffsetSpeed = 1;
	Phase.jointOffset = Vector(0, 5);
	Phase.supportOffsetSpeed = 1;
	Phase.supportOffset = Vector(-10, -15);
	
	Phase.soundStart = CreateSoundContainer("Stab Whoosh CED Combat Knife", "CED.rte");
	Phase.soundStartStopsOnHit = true;
	Phase.soundEnd = nil;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-5, 6);
	Phase.stanceOffsetEnd = Vector(40, 0);
	Phase.stanceEasingFunc = self.EaseLinear;
	
	Phase.jointOffsetSpeed = 1;
	Phase.jointOffset = Vector(0, 5);
	Phase.supportOffsetSpeed = 1;
	Phase.supportOffset = Vector(-5, -5);
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(25, 0);
	Phase.stanceOffsetEnd = Vector(-5, 6);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	phaseSet.Name = "Overhead Stab PhaseSet";
	phaseSet.canBeCombodInto = true;
	phaseSet.sameInputComboPhaseSet = nil;
	phaseSet.isBlockingPhaseSet = false;
	phaseSet.isAttackingPhaseSet = true;
	...
	Phase.Name = "Overhead Stab Prepare";
	Phase.Duration = 250;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(0, 0);
	Phase.stanceOffsetEnd = Vector(-20, -25);
	Phase.stanceEasingFunc = self.EaseLinear;
	
	Phase.jointOffsetSpeed = 1;
	Phase.jointOffset = Vector(0, 5);
	Phase.supportOffsetSpeed = 1;
	Phase.supportOffset = Vector(0, 8);
	...
	Phase.Name = "Overhead Stab Late Prepare";
	Phase.Duration = 50;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-20, -25);
	Phase.stanceOffsetEnd = Vector(-10, -15);
	Phase.stanceEasingFunc = self.EaseLinear;
	...
	Phase.Name = "Overhead Stab Attack";
	Phase.Duration = 100;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-10, -15);
	...
	Phase.Name = "Overhead Stab Rebound";
	Phase.Duration = 200;
	...
	Phase.Name = "Overhead Stab Recover";
	Phase.Duration = 200;
	...
	Phase.stanceOffsetSpeed = 1;	
	Phase.stanceOffsetStart = Vector(-1, -15);
	...
	Phase.supportOffsetSpeed = 1;
	Phase.supportOffset = Vector(999, 999);
	Phase.soundStart = CreateSoundContainer("Equip CED Combat Knife", "CED.rte");
	Phase.soundStartStopsOnHit = false;
	Phase.soundEnd = nil;
